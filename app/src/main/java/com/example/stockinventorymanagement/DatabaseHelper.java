...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //Add Employee Data
    public void addProduct(EmployeeModelClass employeeModelClass){
        ContentValues contentValues = new ContentValues();
        contentValues.put(DatabaseHelper.NAME, employeeModelClass.getPname());
        contentValues.put(DatabaseHelper.EMAIL, employeeModelClass.getBrate());
